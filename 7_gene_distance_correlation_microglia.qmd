...
format: html
code-fold: true
tags: [xenium, coregistration, halo, correlation, microglia]
---
...
# mg <- qs2::qs_read(paste0(path, "20260225-mg_kai.qs2"))
# mg <- UpdateSeuratObject(mg)
# mg_slide1 <- subset(mg, subset = Slide == "Slide1")
# mg_slide2 <- subset(mg, subset = Slide == "Slide2")
# qs2::qs_save(mg_slide1, paste0(path, "20260225-mg_kai_slide1.qs2"))
# qs2::qs_save(mg_slide2, paste0(path, "20260225-mg_kai_slide2.qs2"))
...
# Compute distances for microglia only
...
```{r}
#| label: cell-counts
# Add treatment info from Seurat metadata

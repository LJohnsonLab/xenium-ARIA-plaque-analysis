...
# qs2::qs_save(aria_sct_split, paste0(seurat_path, "20260320_fullobj_correctedChloe_sct_SPLIT.qs2"))
...
qs2::qs_save(aria_sct_split, paste0(seurat_path, "20260320_fullobj_correctedChloe_banksy_agf=TRUE_sct.qs2"))
```

```{r}
#| label: load-banksy
aria_sct_split <- qs2::qs_read(paste0(seurat_path, "20260320_fullobj_correctedChloe_banksy_agf=TRUE_sct.qs2"))
```
